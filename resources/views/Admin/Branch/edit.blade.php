                ...
                <div class="card">
                    <form  action="{{route('branch.update',$branch->id)}}" method="POST">
                        ...
                        <div class="p-3 border-bottom d-flex align-items-center justify-content-center ">
                            <h2 class="font-weight-bolder form-heading">Edit</h2>
                        </div>        
                        <div class="p-3 px-4 py-4 border-bottom">
                            <label for="Branch-name">Branch-name</label>
                            <input id="Branch-name" type="text" class="form-control"  autofocus placeholder="Branch Name..." name="branch_name" value="{{$branch->name}}">
                            <div class="form mt-4">
                                <label for="Amount-per-patient">Amount Per Patient</label>
                                <input id="Amount-per-patient" type="text" class="form-control"  placeholder="Amount Per Patient" name="amount_of_patient" value="{{$branch->amountPerPatient}}">
                            </div> 
